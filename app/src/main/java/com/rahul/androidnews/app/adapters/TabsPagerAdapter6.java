...
import com.rahul.androidnews.app.utils.Constants6;
import com.rahul.androidnews.app.utils.NewsFeedParser;

import java.util.ArrayList;
import java.util.List;

public class TabsPagerAdapter6 extends PagerAdapter {
    ...
    public TabsPagerAdapter6(Activity activity) {
    ...
    public void performAsyncTask(int pos, RecyclerView mrecyclerView) {
        ...
        if (isNetworkAvailable) {
            ...
            new DoRssFeedTask(mrecyclerView, progressBar).execute(Constants6.TOPSTORIES[pos]);
