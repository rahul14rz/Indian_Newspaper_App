...
import com.rahul.androidnews.app.utils.Constants4;
import com.rahul.androidnews.app.utils.NewsFeedParser;

import java.util.ArrayList;
import java.util.List;

public class TabsPagerAdapter4 extends PagerAdapter {
    ...
    public TabsPagerAdapter4(Activity activity) {
    ...
    public void performAsyncTask(int pos, RecyclerView mrecyclerView) {
        ...
        if (isNetworkAvailable) {
            ...
            new DoRssFeedTask(mrecyclerView, progressBar).execute(Constants4.TOPSTORIES[pos]);
