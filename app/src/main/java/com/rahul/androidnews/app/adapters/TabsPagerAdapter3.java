...
import com.rahul.androidnews.app.utils.Constants3;
import com.rahul.androidnews.app.utils.NewsFeedParser;

import java.util.ArrayList;
import java.util.List;

public class TabsPagerAdapter3 extends PagerAdapter {
    ...
    public TabsPagerAdapter3(Activity activity) {
    ...
    public void performAsyncTask(int pos, RecyclerView mrecyclerView) {
        ...
        if (isNetworkAvailable) {
            ...
            new DoRssFeedTask(mrecyclerView, progressBar).execute(Constants3.TOPSTORIES[pos]);
