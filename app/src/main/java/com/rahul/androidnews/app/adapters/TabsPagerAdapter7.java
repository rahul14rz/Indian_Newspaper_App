...
import com.rahul.androidnews.app.utils.Constants7;
import com.rahul.androidnews.app.utils.NewsFeedParser;

import java.util.ArrayList;
import java.util.List;

public class TabsPagerAdapter7 extends PagerAdapter {
    ...
    public TabsPagerAdapter7(Activity activity) {
    ...
    public void performAsyncTask(int pos, RecyclerView mrecyclerView) {
        ...
        if (isNetworkAvailable) {
            ...
            new DoRssFeedTask(mrecyclerView, progressBar).execute(Constants7.TOPSTORIES[pos]);
