...
import com.rahul.androidnews.app.utils.Constants8;
import com.rahul.androidnews.app.utils.NewsFeedParser;

import java.util.ArrayList;
import java.util.List;

public class TabsPagerAdapter8 extends PagerAdapter {
    ...
    public TabsPagerAdapter8(Activity activity) {
    ...
    public void performAsyncTask(int pos, RecyclerView mrecyclerView) {
        ...
        if (isNetworkAvailable) {
            ...
            new DoRssFeedTask(mrecyclerView, progressBar).execute(Constants8.TOPSTORIES[pos]);
