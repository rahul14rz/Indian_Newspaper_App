...
import com.rahul.androidnews.app.utils.Constants5;
import com.rahul.androidnews.app.utils.NewsFeedParser;

import java.util.ArrayList;
import java.util.List;

public class TabsPagerAdapter5 extends PagerAdapter {
    ...
    public TabsPagerAdapter5(Activity activity) {
    ...
    public void performAsyncTask(int pos, RecyclerView mrecyclerView) {
        ...
        if (isNetworkAvailable) {
            ...
            new DoRssFeedTask(mrecyclerView, progressBar).execute(Constants5.TOPSTORIES[pos]);
