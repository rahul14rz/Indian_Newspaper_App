...
import com.rahul.androidnews.app.utils.Constants9;
import com.rahul.androidnews.app.utils.NewsFeedParser;

import java.util.ArrayList;
import java.util.List;

public class TabsPagerAdapter9 extends PagerAdapter {
    ...
    public TabsPagerAdapter9(Activity activity) {
    ...
    public void performAsyncTask(int pos, RecyclerView mrecyclerView) {
        ...
        if (isNetworkAvailable) {
            ...
            new DoRssFeedTask(mrecyclerView, progressBar).execute(Constants9.TOPSTORIES[pos]);
