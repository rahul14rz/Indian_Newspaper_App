...
import com.rahul.androidnews.app.utils.ConnectionDetector;
import com.rahul.androidnews.app.utils.Constants2;
import com.rahul.androidnews.app.utils.NewsFeedParser;

import java.util.ArrayList;
import java.util.List;

public class TabsPagerAdapter2 extends PagerAdapter {
    String tabs[] = {"Latest Stories", "Sports", "Cinema"};
    Activity activity;
    ...
    public TabsPagerAdapter2(Activity activity) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        view = activity.getLayoutInflater().inflate(R.layout.recyclerview_pager, container, false);
    ...
    public void performAsyncTask(int pos, RecyclerView mrecyclerView) {
        ...
        if (isNetworkAvailable) {
            ...
            new DoRssFeedTask(mrecyclerView, progressBar).execute(Constants2.TOPSTORIES[pos]);
